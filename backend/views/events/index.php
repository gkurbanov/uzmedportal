...
$this->title = 'События на главной странице';
        ...
        <div class="table-responsive">
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                ...
                <tr class="text-left">
                    ...
                    <th style="min-width: 110px"><?= Events::instance()->getAttributeLabel('title_ru') ?></th>
                    <th style="min-width: 110px">
                        <span class="text-info"><?= Events::instance()->getAttributeLabel('created_at') ?></span>
                    </th>
                    <th style="min-width: 120px"><?= Events::instance()->getAttributeLabel('slug') ?></th>
                    <th style="min-width: 120px"><?= Events::instance()->getAttributeLabel('is_active') ?></th>
