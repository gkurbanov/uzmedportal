                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-xl-12 col-lg-12 col-form-label text-left"><?= RelatedResource::instance()->getAttributeLabel('image') ?></label>
                            <div class="col-lg-12 col-xl-12">
                                <div class="image-input image-input-outline <?php if (!$model->image) {
                                    ...
                                    <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                          data-table="<?= RelatedResource::tableName() ?>"
                                          data-column="image"
                                          data-value="<?= $model->image ?>"
                                          data-input="<?= RelatedResource::instance()->getAttribute("image") ?>"
                                          data-id="<?= $model->id ?>"
