        ...
        <div class="table-responsive">
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                ...
                <tr class="text-left">
                    ...
                    <th style="min-width: 110px"><?= Slider::instance()->getAttributeLabel('title_ru') ?></th>
                    <th style="min-width: 110px">
                        <span class="text-info"><?= Anons::instance()->getAttributeLabel('created_at') ?></span>
                    </th>
                        ...
                        <td>
                            <?php if ($record->image) { ?>
                                <div class="symbol symbol-50 flex-shrink-0">
                                    <img src="/backend/web/media/slider/slider_<?= $record->id; ?>/<?= $record->image ?>"
                                         alt="photo">
                                </div>
                            <?php } ?>
                        </td>
