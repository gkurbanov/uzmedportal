...
<div class="card card-custom gutter-b example example-compact">
    ...
    <div class="card-body">
                        ...
                        <div class="checkbox-inline">
                            <?= $form->field($model, 'is_active',
                                [
                                    ...
                                    'label' => '<span></span>' . Projects::instance()->getAttributeLabel('is_active'),
                                    'labelOptions' => [
                                        'class' => 'checkbox'
                                    ],
                                ]
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-right"><?= Projects::instance()->getAttributeLabel('image_ru') ?></label>
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-outline <?php if (!$model->image_ru) {
                            ...
                            <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                  data-table="<?= Projects::tableName() ?>"
                                  data-column="image_ru"
                                  data-value="<?= $model->image_ru ?>"
                                  data-input="<?= Projects::instance()->getAttribute("image_ru") ?>"
                                  data-id="<?= $model->id ?>"
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label text-right"><?= Projects::instance()->getAttributeLabel('image_uz') ?></label>
                    <div class="col-lg-9 col-xl-6">
                        ...
                        <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                              ...
                              data-input="<?= Projects::instance()->getAttribute("image_uz") ?>"
                              data-id="<?= $model->id ?>"
                              data-action="remove" data-toggle="tooltip" title="Удалить изображение">
                                    <i class="ki ki-bold-close icon-xs text-muted"></i>
                                </span>
