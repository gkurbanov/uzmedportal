...
$this->title = 'Проекты на главной странице';
        ...
        <div class="table-responsive">
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                ...
                <tr class="text-left">
                    ...
                    <th style="min-width: 110px"><?= Projects::instance()->getAttributeLabel('title_ru') ?></th>
                    <th style="min-width: 110px">
                        <span class="text-info"><?= Projects::instance()->getAttributeLabel('created_at') ?></span>
                    </th>
                    <th style="min-width: 120px"><?= Projects::instance()->getAttributeLabel('slug') ?></th>
                    <th style="min-width: 120px"><?= Projects::instance()->getAttributeLabel('is_active') ?></th>
