...
/**
 * This is the model class for table "anons".
 *
 * @property int $id
 ...
 */
class Anons extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title_ru', 'title_uz', 'slug'], 'string', 'max' => 255],
            [['seo_title_ru', 'seo_title_uz'], 'string', 'max' => 100],
            [['seo_description_ru', 'seo_keyword_ru', 'seo_description_uz', 'seo_keyword_uz', 'image_ru', 'image_uz',], 'string', 'max' => 200],
//            [[], 'file', 'skipOnEmpty' => true, 'extensions' => 'png, jpg', 'message' => "dsasd"],
        ];
    }
